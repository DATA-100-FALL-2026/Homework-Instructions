...
```{r photo, fig.margin = TRUE, echo = FALSE, fig.width = 3, fig.cap = "Photo by Daniel Cheung on Unsplash", fig.alt = "Photo of colorful Lego bricks.", eval = TRUE}
...
Be sure to include your research question, the variables you'll need to use to answer the question, the type of plot that will answer the question along with the code, and 2-3 sentences interpreting your results. **Give your plot a title, clear axis labels, and a `fig.alt` description in the chunk header** — just like the plots you've made in earlier assignments and labs.
