...
4. **Push** to GitHub
5. Verify your changes are visible in your GitHub repo (check your `.Rmd` file)
...
```{r accident-density-plot, eval = FALSE, fig.alt = "Density plot of accident times by severity, faceted by weekday versus weekend"}
...
# Your code here
# Accessibility tip: add a fig.alt = "..." option to this chunk header
# describing what your plot shows, for screen reader users.
```
...
**✓ Final check:** The PDF you upload to Canvas is the basis for grading — double-check it before submitting to make sure every code chunk ran without errors and all of your answers and plots show up in the output. Also visit your GitHub repo to confirm all your commits are pushed there; the GitHub push is required as your backup checkpoint, but grading is based on the PDF.
